...
export default {
    ...
    computed: {
        ...
        time () {
            ...
            if (+destime[0] < +deptime[0]) {
                destime[0] += 24
            }
            let hour = +destime[0] - deptime[0]
            // let min = +destime[1] - deptime[1]
            let min = (+destime[0]*60 + destime[1] - deptime[0]*60 - deptime[1])%60
            return hour + '时' + min + '分'
        }
    },
    methods: {
